        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentChapter = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true),
                    TotalMinutesRead = table.Column<int>(type: "int", nullable: false),
                    TotalPagesRead = table.Column<int>(type: "int", nullable: false),
                    LastReadDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Conversations",
                columns: new[] { "Id", "CreatedBy", "DateCreated", "DateModified", "IsDeleted", "LastMessageAt", "Title" },
                values: new object[] { new Guid("b235f2ed-bb4e-4bd2-a03d-0e3c17aaf2e2"), "c117635d-96e0-409b-9fae-72976ec9c42a", new DateTime(2026, 7, 19, 22, 21, 37, 47, DateTimeKind.Utc).AddTicks(6276), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "Soulshelf Group Chat" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("c117635d-96e0-409b-9fae-72976ec9c42a"), "system", new DateTime(2026, 7, 19, 22, 21, 36, 965, DateTimeKind.Utc).AddTicks(9590), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", "AQAAAAIAAYagAAAAEHaPPOH/SklTp9J6kzhJxdp8/VTAkDg9x+/hJUQVwONInIm6LdQge2AZgBjWzQnRHA==", null, false, true, "admin", "admin", null, null });

            migrationBuilder.InsertData(
                table: "UserConversations",
                columns: new[] { "ConversationId", "UserId" },
                values: new object[] { new Guid("b235f2ed-bb4e-4bd2-a03d-0e3c17aaf2e2"), new Guid("c117635d-96e0-409b-9fae-72976ec9c42a") });

            migrationBuilder.InsertData(
                table: "Wallets",
                columns: new[] { "Id", "Balance", "CreatedBy", "DateCreated", "DateModified", "IsDeleted", "LastPayoutDate", "UserId" },
                values: new object[] { new Guid("7526dc11-4739-4015-a773-bde0b26cc4f1"), 0m, "admin@gmail.com", new DateTime(2026, 7, 19, 22, 21, 37, 47, DateTimeKind.Utc).AddTicks(2089), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("c117635d-96e0-409b-9fae-72976ec9c42a") });
